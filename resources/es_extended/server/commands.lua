...
ESX.RegisterCommand('setjob', 'sousmerde', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setjob2', 'sousmerde', function(xPlayer, args, showError)
...
ESX.RegisterCommand('car', 'sousmerde', function(xPlayer, args, showError)
...
ESX.RegisterCommand({'cardel', 'dv'}, 'sousmerde', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveitem', 'sousmerde', function(xPlayer, args, showError)
...
ESX.RegisterCommand('tpm', "sousmerde", function(xPlayer, args, showError)
	xPlayer.triggerEvent("esx:tpm")
end, true)

ESX.RegisterCommand('goto', "sousmerde", function(xPlayer, args, showError)
...
ESX.RegisterCommand('bring', "sousmerde", function(xPlayer, args, showError)
...
ESX.RegisterServerCallback('tesquelgrouppepep', function(source, cb)
